"""EVOL Material Tool -- view absorbed material buffer contents."""
import os
import json
import time
...
class EvolMaterialTool(Tool):
    async def execute(self, **kwargs) -> Response:
        try:
            ...
            filename = f'{evoldir}/material_{ts}.json'
            ...
            return Response(message=f"EVOL material error: {e}", break_loop=False)
