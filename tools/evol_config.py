"""EVOL Config Tool -- show current configuration."""
import os
import json
import time
...
class EvolConfigTool(Tool):
    async def execute(self, **kwargs) -> Response:
        try:
            ...
            filename = f'{evoldir}/config_{ts}.json'
            ...
            return Response(message=f"EVOL config error: {e}", break_loop=False)
