"""EVOL Status Tool -- show heartbeat, cascade counters, cycle state."""
import os
import json
import time
...
class EvolStatusTool(Tool):
    async def execute(self, **kwargs) -> Response:
        try:
            ...
            filename = f'{evoldir}/status_{ts}.json'
            ...
            return Response(message=f"EVOL status error: {e}", break_loop=False)
